...
DROP TABLE IF EXISTS `wps1_job_transactions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wps1_job_transactions` (
...
LOCK TABLES `wps1_job_transactions` WRITE;
/*!40000 ALTER TABLE `wps1_job_transactions` DISABLE KEYS */;
/*!40000 ALTER TABLE `wps1_job_transactions` ENABLE KEYS */;
UNLOCK TABLES;
