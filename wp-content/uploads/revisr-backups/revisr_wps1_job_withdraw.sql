...
DROP TABLE IF EXISTS `wps1_job_withdraw`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wps1_job_withdraw` (
...
LOCK TABLES `wps1_job_withdraw` WRITE;
/*!40000 ALTER TABLE `wps1_job_withdraw` DISABLE KEYS */;
/*!40000 ALTER TABLE `wps1_job_withdraw` ENABLE KEYS */;
UNLOCK TABLES;
